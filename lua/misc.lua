...
local user_test_code         = require('user-test-code')
local user_friendly_snippets = require('user-friendly-snippets')
local user_options           = require('user-options')
local user_auto_session      = require("user-auto-session")
...
function M.setup()
  ...
  user_cmp.setup()
  user_test_code.setup()
  user_friendly_snippets.setup()
  -- a set of vim.opts
  user_options.setup()
